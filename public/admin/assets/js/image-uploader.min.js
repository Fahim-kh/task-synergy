...
e.fn.imageUploader = function(t) {
    let n,
        i = {
            ...
            extensions: [".jpg", ".webp", ".jpeg", ".png", ".gif", ".svg"],
            mimes: ["image/jpeg", "image/webp", "image/png", "image/gif", "image/svg+xml"],
            maxSize: void 0,
            maxFiles: void 0
        },
        a = this,
    ...
    let o = function() {
        ...
        l = function(t, i, o) {
            let l = e("<div>", { class: "uploaded-image" }),
                r = e("<img>", { src: t }).appendTo(l),
                p = e("<button>", { class: "delete-image" }).appendTo(l);
            e("<i>", { class: "fa-close" }).appendTo(p);
            if (o) {
                l.attr("data-preloaded", !0);
                e("<input>", { type: "hidden", name: a.settings.preloadedInputName + "[]", value: i }).appendTo(
                    l
                );
        ...
        p = function(t) {
            ...
            let i = e(this),
                ...
                l = [];
            if (o.length > 3) {
                $("#modalMessage").text("You can only select a maximum of three files.");
        ...
        m = function(e, t) {
            if (e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) {
              $("#modalMessage").text(`The file "${t.name}" could not be added because the limit of ${a.settings.maxFiles} files was reached.`);
              $("#exampleModal").modal("show");
              return false;
            }
            return true;
