    ...
    <div class=" app-content">
        <div class="side-app">
            ...
            <div class="page-header">
                <h4 class="page-title"><i class="fe fe-grid mr-1"></i>Edit Team</h4>
                <ol class="breadcrumb">
                        ...
                        <div class="card-body">
                            <form method="post" role="form" class="form-horizontal" id="formCreate"
                                ...
                                <div class="form-group row  @error('name') has-error @enderror">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" class="form-control" id="name"
                                            placeholder="Enter Full Name" value="{{ $team->name }}">
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div id="image-holder" style="width:150px; margin-top:5px;">
                                            ...
                                            @else
                                                <img src="{{ url('') }}/uploads/team/{{ $team->team_img }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="ckeditor form-control" name="wysiwyg-editor">{{ $team->bio }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select name="status" id="status" class="form-control select2 ">
                                            <option value="0" {{ $team->status == 0 ? 'selected' : '' }}>DEACTIVE
                                            </option>
                                            <option value="1" {{ $team->status == 1 ? 'selected' : '' }}>ACTIVE
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="label label-danger">{{ $message }}</div>
