...
<div class="app-content">
	<div class="side-app">
		<div class="page-header">
			<h3 class="page-title"><i class="fe fe-home mr-1"></i>Department Create</h3>
			<ol class="breadcrumb">
        ...
        <div class="card col-lg-8 col-md-col-8 col-sm-12 mx-auto">
            <div class="card-body">
                <form action="{{ route('department.store') }}" method="post" id="locationStore">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description')  is-invalid state-invalid @enderror" name="description" id="description"></textarea>
