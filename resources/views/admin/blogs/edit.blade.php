            ...
            <div class="card">
                <div class="card-body">
                  <form method="post" role="form" class="form-horizontal" id="formCreate"
                      enctype="multipart/form-data" action="{{ route('blog.update',$blog->id) }}">
                      @csrf
                      @method('put')
                      <div class="from-group">
                        <label for="heading">Title*</label>
                        <input type="text" class="form-control  @error('name') has-error @enderror" name="name" id="heading" value="{{ $blog->name }}">
                        @error('name')
                      ...
                      <div class="from-group">
                        ...
                        <textarea name="body" id="body" class="form-control content @error('body') has-error @enderror">{!! $blog->body !!}</textarea>
                        @error('body')
                          <div class="label label-danger">{{ $message }}</div>
                        @enderror
                      </div>
