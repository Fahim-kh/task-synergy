    ...
    <div class=" app-content">
        <div class="side-app">
            <div class="page-header">
                <h4 class="page-title"><i class="fe fe-grid mr-1"></i> Edit Services</h4>
                <ol class="breadcrumb">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" role="form" class="form-horizontal" id="formEdit" enctype="multipart/form-data"
                                ...
                                <div class="tabs-menu1 ">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li class=""><a href="#tab5" class="active" data-toggle="tab">Services
                                                info</a></li>
                                        {{-- <li  class="aditional_info " style="{{ ($service->add_more==1)? '': 'display:none'}}"><a href="#tab6" data-toggle="tab">Aditional Information</a></li> --}}
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-pane active" id="tab5">
                                        <section class="general-info">
                                            <div class="form-group row  @error('name') has-error @enderror">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" id="heading" class="form-control" name="name"
                                                        placeholder="Enter Heading" value="{{ $service->name }}">
                                                    @error('name')
                                            ...
                                            <div class="form-group row  @error('paragraph') has-error @enderror">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="ckeditor form-control" id="paragraph" name="paragraph" placeholder="Enter Paragraph">{{ $service->paragraph }}</textarea>
                                                    @error('paragraph')
                                                        <div class="label label-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
